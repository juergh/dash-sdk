...
Devenv.com windows/dash/dash.sln /build Release
rem Devenv.com windows/dash/dash.sln /build "Release"
GOTO :EOF

:build_debug
REM DESC: starts build process in debug mode.
Devenv.com windows/dash/dash.sln /build Debug
rem Devenv.com windows/dash/dash.sln /build "Debug"
GOTO :EOF

:clean_release
REM DESC: cleans solution under release mode.
Devenv.com windows/dash/dash.sln /clean Release
rem Devenv.com windows/dash/dash.sln /clean "Release"
GOTO :EOF

:clean_debug
REM DESC: cleans solution under debug mode.
Devenv.com windows/dash/dash.sln /clean Debug
rem Devenv.com windows/dash/dash.sln /clean "Debug"
GOTO :EOF
