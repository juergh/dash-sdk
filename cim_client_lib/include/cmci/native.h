...
CMCI_Export void				native_release_CMPIValue ( CMPIType, CMPIValue * val );
CMCI_Export CMPIValue			native_clone_CMPIValue ( CMPIType, CMPIValue * val, CMPIStatus * );
CMCI_Export CMPIString*			native_new_CMPIString ( const char *, CMPIStatus * );
CMCI_Export CMPIArray*			native_new_CMPIArray ( CMPICount size, CMPIType type,
								CMPIStatus * );
CMCI_Export void				native_array_increase_size ( CMPIArray *, CMPICount );
CMCI_Export CMPIEnumeration*	native_new_CMPIEnumeration ( CMPIArray *, CMPIStatus * );
CMCI_Export CMPIInstance*		native_new_CMPIInstance ( CMPIObjectPath *, CMPIStatus * );
CMCI_Export CMPIObjectPath*		native_new_CMPIObjectPath ( const char *, const char*,
								CMPIStatus * );
CMCI_Export CMPIArgs*			native_new_CMPIArgs ( CMPIStatus * );
CMCI_Export CMPIDateTime*		native_new_CMPIDateTime ( CMPIStatus * );
CMCI_Export CMPIDateTime*		native_new_CMPIDateTime_fromBinary ( CMPIUint64,
								CMPIBoolean, CMPIStatus * );
CMCI_Export CMPIDateTime*		native_new_CMPIDateTime_fromChars ( const char *,
											CMPIStatus * );
#ifdef __cplusplus
}
#endif
...
CMCI_Export CMPIValue	str2CMPIValue(CMPIType type, char *val, struct XtokValueReference *ref);
CMCI_Export char*		value2Chars(CMPIType type, CMPIValue * value);
