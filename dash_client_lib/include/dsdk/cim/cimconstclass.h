...
/**
 * cimconstclass.h
 * A class CIM Constan Class.
 */
#ifndef __DSDK_CIMCONSTCLASS_H__
#define __DSDK_CIMCONSTCLASS_H__
#include <cmci/cmci.h>
#include <string>
...
/**
 * @class CCIMConstClass
 * @brief A class representing a CIM Constant Class. This class provides a
 * nice C++ wrapper on the low level CIM Constant class. This class 
...
public:
	/** 
	 * Construct this object from the class namespace.
	 */
	CCIMConstClass (string /* cn */) { throw ECIMMethodNotImplemented ("CCIMConstClass"); }

	/**
	 * Convert the low level Class to CCIMConstClass. The low level 
	 * ConstClass should not be released or assigned to another object after
	 ...
	 * ConstClass
	 */
	static CCIMConstClass toCCIMConstClass (CMPIConstClass* cls, 
...
public:
	 ...
	 * Copy constructor
	 */
	CCIMConstClass (const CCIMConstClass& cls);

	/**
	 * Assignment operator.
	 */
	const CCIMConstClass& operator = (const CCIMConstClass& rhs)
													throw (ECIMError);
...
public:
	 ...
	 */
	CCIMData getPropertyQualifier (const string& pname, const string& qname) const throw (ECIMError);
...
public:
	 ...
	 */
	CMPIConstClass* getLowLevelObject (void) const { return _cls; }

public:
	typedef CIterator<CKeyClass<CCIMConstClass> > iterator;

public:
	/*--------- CCIMValue Conversion adapter required functions ----------*/
	typedef CCIMConstClass	AdapteeType;
    static const CMPIType 	cmpi_type = CMPI_class;

	/**
	 * Creates this object from a string. This is not supported.
	 */
    static CCIMConstClass create (string /* val_str */) 
    { 
	 ...
	 */
    static CCIMConstClass create (CMPIValue* val, bool auto_release)         
    {                                                                       
        return toCCIMConstClass (val->cls, auto_release);
    }

	/**
	 * Converts @p val to a low level CMPIValue object.
	 */
	static CMPIValue toCMPIValue (CCIMConstClass val)									
    {                                                                       
        CMPIValue cv;                                                       
        cv.cls = val.getLowLevelObject ();                                                   
		return cv;															
    }          
...
private:
	...
	CCIMConstClass () { /* Empty */ }

	/* Build the object from cmpi const class */
	CCIMConstClass (CMPIConstClass* cls) : _cls (cls) { /* Empty */ }
...
#endif	/* __DSDK_CIMCONSTCLASS_H__ */
