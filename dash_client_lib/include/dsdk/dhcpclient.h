...
/**
 * dhcpclient.h
 * A class representing a DHCP Protocol Endpoint.
 */
#ifndef __DSDK_DHCPCLIENT_H__
#define __DSDK_DHCPCLIENT_H__
...
class CDHCPClient;
typedef CAPIIterator<CDHCPClient, CIM_DHCPProtocolEndpoint> _CDHCPClientIterator;

/**
  * @class CDHCPClient
  * @brief A class representing a DHCP Protocol Endpoint
  **/
class DSDK_Export CDHCPClient
{
public:
	DECLARE_API_ITERATOR (CDHCPClient);
	typedef CIM_DHCPProtocolEndpoint CIMType;

public:
	/**
	 * Enumerates all the DHCPClients present under a MAP.
	 * @param client	Pointer to the client interface.
	 * @param cached	true  - Enable caching \n
	 *					false - Disable caching.
	 * @return			Iterator to the DhcpClient.
	 */
	static CDHCPClient::iterator enumDHCPClients (IClient* client,
										 				  bool cached = true);
...
public:
	 ...
	 */
	CIM_DHCPProtocolEndpoint* getCIMObject (void) const { return _dhcp; }
...
public:
	 ...
	 * @ return the protocol type description.
	 */
	 ...
	 */
	string getClientState (void) const;
...
public:
	/**
	 * Construct this object from the corresponding CIM_DHCPClient 
	 * object
	 */
	CDHCPClient (const CIM_DHCPProtocolEndpoint& dhcp); 

	/**
	 * Copy constructor
	 */
	CDHCPClient (const CDHCPClient& dhcp);
	 ...
	 * Assignment operator
	 */
	const CDHCPClient& operator = (const CDHCPClient& rhs);
...
private:
	CIM_DHCPProtocolEndpoint*	_dhcp;
};

};	/* namespace dsdk */

#endif /*__DSDK_DHCPCLIENT_H__*/
