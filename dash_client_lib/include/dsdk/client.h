 ...
 * Client Interface.
 */
#ifndef __DSDK_CLIENT_H__
#define __DSDK_CLIENT_H__
...
public:
	...
	/**
	 * Enumerate instance names of the class (and subclasses) defined by &p op.
	 * @param op	Object path containing the namespace and classname.
	 * @return		The iterator to the object paths.
	 * @throws		ECIMError.
	 */
	virtual CCIMObjectPath::iterator enumInstanceNames 
											(const CCIMObjectPath& op) = 0;
	...
	virtual CCIMObjectPath::iterator enumInstanceNames 
										(const CCIMObjectPath& op,
										 const vector<string>& key_props) = 0;
	 ...
	 * @throws		ECIMError
	 */
	virtual void deleteInstance (const CCIMObjectPath& op) = 0;
	...
	virtual string subscribeEvent (const CCIMObjectPath& op,
								   ...
								   const string&	filter) = 0;

	virtual string subscribeToEvent(const CCIMObjectPath& op, const vector<string>& params) = 0;

	/**
	 * Un subscribe a previously subscribed event.
	 * @throws		ECIMError.
	 */
	virtual void unsubscribeEvent (const CCIMObjectPath& op) = 0;
	 ...
	 * @throws		ECIMError.
	 */
	virtual void renewSubscription (const CCIMObjectPath& op,const string&	renewtime) = 0;
	 ...
	 * @return user
	 */
	virtual string getUser (void) = 0;

	/**
	 * Gets the Password for this client
	 * @return password
	 */
	virtual string getPassword (void) = 0;

	/**
	 * Gets the implementation namespace for this client
	 * @return namesapce
	 */
	virtual string getImplementationNS (void) = 0;

	/**
	 * Gets the interop namespace for this client
	 * @return namesapce
	 */
	virtual string getInteropNS (void) = 0;
...
DSDK_Export extern int    g_dsdk_verbose_level;
DSDK_Export extern string g_dsdk_verbose_file;

#endif /* __DSDK_CLIENT_H__ */
