 ...
 */
#ifndef __DSDK_EVENT_SUBSCRIBE_H__
#define __DSDK_EVENT_SUBSCRIBE_H__
#include <string>
#include <vector>
#include <map>
 ...
 */
DSDK_Export string subscribeEvent (IClient*  client,
...
DSDK_Export string subscribeEvent (IClient*  client,
								   ...
								   const string&	dialect,
								   const string&	filter,
								   const string&	resource_uri = "http://schemas.dmtf.org/wbem/wscim/1/*");
 ...
 */
DSDK_Export void unsubscribeEvent (IClient*  client, const string& uuid);
 ...
 * @param uuid	The UUID of the subscription.
 */
DSDK_Export void renewSubscription (IClient*  client, const string& uuid);


};

#endif /*__DSDK_EVENT_SUBSCRIBE_H__ */
