 ...
 * Event subscribe api.
 */
#ifndef __CDSDK_EVENTSUBSCRIBE_H__
#define __CDSDK_EVENTSUBSCRIBE_H__
...
#define EVENT_UUID_MAX_LEN		16 + 1
 ...
 * @param uuid				 A buffer of length EVENT_UUID_MAX_LEN to hold the subscription UUID.
 */
DSDKC_Export void 
 ...
 */
DSDKC_Export void unsubscribeEvent (DSDKClient* client, char* uuid);
 ...
 * @param uuid	The UUID of the subscription.
 */
DSDKC_Export void renewSubscription (DSDKClient* client, char* uuid);
...
#endif /* __CDSDK_EVENTSUBSCRIBE_H__*/
